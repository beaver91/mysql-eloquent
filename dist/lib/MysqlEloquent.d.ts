...
declare type DBTable = `${string}.${string}`;
/**
 * `boolean` is EXISTS
 */
declare type WhereConditionOperator = '>' | '>=' | '<' | '<=' | '=' | '!=';
declare type WhereValue = string | number | boolean | object;
...
export default class MysqlEloquent<T extends IndexSignature> {
     ...
     * @returns this
     */
    where(key: string, condition: WhereValue, operator?: WhereConditionOperator): this;
    /**
     * set offset
     * @param offset number
     * @returns
